...
/*
  if (currentMillis - previousMillis  > 23200 && currentMillis - previousMillis < 25200) {
    Serial.println("final -1");
    brightness = 70;
           //MUEVEN A LOS AZULES
      ...
      ledBlock(STEELBLUE, 0, 60); 
      gotoledfull2(STEELBLUE, 70, 88, 23, 3); 
      //ledBlock(STEELBLUE, 98, 108); 
     
      note = true;
  }
  if (currentMillis - previousMillis  > 25200 && currentMillis - previousMillis < 27500) {
    Serial.println("final -1");
    brightness = 70;
           //MUEVEN A LOS AZULES
      ...
      ledBlock(STEELBLUE, 0, 60); 
      ledBlock(STEELBLUE, 70, 88); 
      gotoledfull2(STEELBLUE, 98, 108, 23, 3); 
